...
def _block(r):
    ...
    return (
        ...
        f"| Violation catch rate | {p(r.get('violation_catch_rate'))} |\n"
        f"| Attack success rate | {p(r.get('attack_success_rate'))} |\n"
        f"| Unauthorized-action rate | {p(r.get('unauthorized_action_rate'))} |\n"
